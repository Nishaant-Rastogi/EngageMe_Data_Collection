    ...
    plugin.info = {
        ...
        parameters: {
            ...
            char: {
                ...
                default: "b",
                description: 'Any content here will be displayed inside the stimulus'
    ...
    plugin.stimulus = function (grid, square_size, target, target_color, labels) {
        ...
        for (var i = 0; i < grid.length; i++) {
            ...
            for (var j = 0; j < grid[i].length; j++) {
                ...
                if (grid[i][j] != 0) {
                    stimulus += "border-radius: 50%;border: 2px solid black;"
                }
                ...
                if (grid[i][j] != 0) {
                    ...
                    if (typeof grid[i][j] == 'string') {
                        ...
                        if (grid[i][j] == grid[i][j].toLowerCase()) {
                            stimulus += "background-color: rgb(170,243,0);"
